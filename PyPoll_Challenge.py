...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_percentage = float(county_vote_count) / float(county_voter_turnout) * 100
        county_results = (
        ...
        if (county_vote_count > county_voter_turnout) and (county_vote_percentage > winning_county_vote_percentage):
